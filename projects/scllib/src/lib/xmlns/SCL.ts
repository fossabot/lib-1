...
// Source files:
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL.xsd
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL_BaseSimpleTypes.xsd
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL_BaseTypes.xsd
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL_Communication.xsd
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL_DataTypeTemplates.xsd
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL_Enums.xsd
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL_IED.xsd
// https://raw.githubusercontent.com/romdhanisam/TEST/cxsd/SCL2007B4/SCL_Substation.xsd
...
export interface _tAbstractEqFuncSubFunc extends _tPowerSystemResource {
	type?: string;
	EqSubFunction?: tEqSubFunction[];
	GeneralEquipment?: tGeneralEquipment[];
}
...
export interface _tAccessPoint extends _tUnNaming {
	...
	name: string;
	router?: boolean;
	GOOSESecurity?: tCertificate[];
	LN?: tLN[];
	server?: _tServer;
	ServerAt?: tServerAt;
	Services?: tServices;
	SMVSecurity?: tCertificate[];
}
...
export interface _tBay extends _tEquipmentContainer {
	ConductingEquipment?: tConductingEquipment[];
...
export interface _tControlWithIEDName extends _tControl {
	confRev?: number;
	IEDName?: tControlWithIEDNameIEDNameType[];
}
...
export interface _tHeader extends BaseType {
	id: string;
	nameStructure?: tHeaderNameStructureType;
	revision?: string;
	toolID?: string;
	version?: string;
	History?: tHeaderHistoryType;
	Text?: tText;
}
...
export interface _tLN0 extends _tAnyLN {
	inst: string;
	lnClass: string;
	GSEControl?: tGSEControl[];
	SampledValueControl?: tSampledValueControl[];
...
export interface _tReportControl extends _tControlWithTriggerOpt {
	...
	indexed?: boolean;
	rptID?: string;
	OptFields: tReportControlOptFieldsType;
...
export interface _tSampledValueControl extends _tControlWithIEDName {
	...
	smvID: string;
	Protocol?: tProtocol;
	SmvOpts: tSampledValueControlSmvOptsType;
}
...
export interface _tServer extends _tUnNaming {
	...
	Authentication: tServerAuthenticationType;
	lDevice: _tLDevice[];
}
...
export interface _tServiceConfReportControl extends _tServiceWithMax {
	bufConf?: boolean;
	bufMode?: tServiceConfReportControlBufModeType;
	maxBuf?: number;
}
